    ...
    <div id="titleText">
            ...
            <div id="profile-area">
                    ...
                    <table class="pofolInfoTable">
                        <tr>
                            ...
                            <td>
                                ...
                                <p style="font-size: 16px;">${ requestScope.list[0].gosu.region }<br>${ requestScope.list[0].gosu.moveDistance }
                                </p>
                            </td>
                        </tr>
                    </table>
                ...
                <div style="width: 100%; height: 15%;" align="center">
                    ...
                    <c:if test="${ not empty sessionScope.loginUser and sessionScope.loginUser.userNo ne requestScope.list[0].gosu.gosuNo  }">
                        <button type="button"
                                onclick="location.href='insertChatRoom?gno=${requestScope.list[0].gosu.gosuNo}'">견적 요청하기
                        </button>
                    </c:if>
                </div>
        ...
        <div align="center">
            <c:if test="${ sessionScope.loginUser.userNo eq requestScope.list[0].gosu.gosuNo }">
                <button type="button" class="btn-control" id="btn-deleteForm"
                        onclick="deletePofol(${requestScope.list[0].pofol.pofolNo});">삭제하기
                </button>
                <button type="button" class="btn-control" id="btn-updateForm"
                        onclick="sendUpdatePofol(${requestScope.list[0].pofol.pofolNo});">수정하기
                </button>
            </c:if>
            <button type="button" class="btn-control" id="btn-goList" onclick="location.href='sendPofol.po'">목록으로
            </button>
        </div>
