...
<title>신고 목록</title>
    ...
    #search-option{ width: 150px; margin-top: 30px;}

    /* 리스트 영역 */
    #list-area{ width: 80%; margin: auto; margin-top: 30px;}
    #report-list{width: 100%; text-align: center;}
    #report-list>thead{ background-color: #2a91f7c0; color: white;}
    #report-list>tbody:hover{cursor: pointer;}
    ...
    <div class="outer">
        <div align="center">
            <p id="report-pageTitle">
                <svg xmlns="http://www.w3.org/2000/svg" width="35" height="35" fill="rgba(204, 29, 29)" class="bi bi-person-exclamation" viewBox="0 0 16 16">
