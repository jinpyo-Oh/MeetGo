...
public class MemberController {
	...
	public ModelAndView loginMember(Member m, String saveId, ModelAndView mv, HttpSession session,
	...
	public String insertMember(Member m, String domain, Model model, HttpSession session, String address1,
			String address2) {
	...
	public String updateMember(Member m, Model model, HttpSession session, MultipartFile profileupload) {
		String encPwd = bCryptPasswordEncoder.encode(m.getUserPwd());
	...
	public ModelAndView myEstimate(@RequestParam(value = "cPage", defaultValue = "1") int currentPage, ModelAndView mv,
			HttpSession session) {
		...
		mv.addObject("incomList", list1).addObject("pi1", pi1).addObject("comList", list2).addObject("pi2", pi2)
