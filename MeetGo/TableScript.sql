...
INSERT INTO MEETGO.MEMBER (USER_NO, USER_NAME, USER_ID, USER_PWD, USER_NICKNAME, USER_GENDER, USER_EMAIL, USER_PHONE,
                           USER_PROFILE, ADDRESS, CREATE_DATE, LAST_ACCESS_DATE, USER_STATUS)
VALUES (1001, '윤아', 'user01', '$2a$10$/Y9I7rISMRvUDWigufjhq.f0qeML9zbM/PLGTTO5hFU6sdjp8g6NG', 'USER01', 'M',
        ...
        '서울시 영등포구', TIMESTAMP '2023-12-06 14:21:56', TIMESTAMP '2023-12-06 14:21:56', 1);
INSERT INTO MEETGO.MEMBER (USER_NO, USER_NAME, USER_ID, USER_PWD, USER_NICKNAME, USER_GENDER, USER_EMAIL, USER_PHONE,
                           USER_PROFILE, ADDRESS, CREATE_DATE, LAST_ACCESS_DATE, USER_STATUS)
VALUES (1002, '수지', 'user02', '$2a$10$/Y9I7rISMRvUDWigufjhq.f0qeML9zbM/PLGTTO5hFU6sdjp8g6NG', 'USER02', 'M',
        ...
        TIMESTAMP '2023-12-06 14:21:56', TIMESTAMP '2023-12-06 14:21:56', 1);
INSERT INTO MEETGO.MEMBER (USER_NO, USER_NAME, USER_ID, USER_PWD, USER_NICKNAME, USER_GENDER, USER_EMAIL, USER_PHONE,
                           USER_PROFILE, ADDRESS, CREATE_DATE, LAST_ACCESS_DATE, USER_STATUS)
VALUES (1003, '예인', 'user03', '$2a$10$/Y9I7rISMRvUDWigufjhq.f0qeML9zbM/PLGTTO5hFU6sdjp8g6NG', 'USER03', 'M',
        ...
        '대전 오정동', TIMESTAMP '2023-12-06 14:21:56', TIMESTAMP '2023-12-06 14:21:56', 1);
INSERT INTO MEETGO.MEMBER (USER_NO, USER_NAME, USER_ID, USER_PWD, USER_NICKNAME, USER_GENDER, USER_EMAIL, USER_PHONE,
                           USER_PROFILE, ADDRESS, CREATE_DATE, LAST_ACCESS_DATE, USER_STATUS)
...
VALUES (1005, '강형욱', 'user05', '$2a$10$/Y9I7rISMRvUDWigufjhq.f0qeML9zbM/PLGTTO5hFU6sdjp8g6NG', '강형욱 닉네임', 'M',
        ...
        '안산시 상록구', TIMESTAMP '2023-12-06 17:26:57', TIMESTAMP '2023-12-06 17:26:57', 2);
...
VALUES (1014,
        ...
        1, 1003);
INSERT INTO MEETGO.POFOL (POFOL_NO, POFOL_SERVICE, POFOL_TITLE, POFOL_PRICE, POFOL_CONTENT, POFOL_VISITED,
                          POFOL_CREATE_DATE, POFOL_STATUS, GOSU_NO)
VALUES (1001, 503, '포폴 제목', '100000', '포폴 내용이 들어가는 자리입니다 시작


포폴 내용이 들어가는 자리입니다 끝', 1548, TIMESTAMP '2023-12-06 17:10:38', 1, 1001);
INSERT INTO MEETGO.POFOL (POFOL_NO, POFOL_SERVICE, POFOL_TITLE, POFOL_PRICE, POFOL_CONTENT, POFOL_VISITED,
                          POFOL_CREATE_DATE, POFOL_STATUS, GOSU_NO)
VALUES (1002, 601, '포폴 제목', '200000', '포폴 내용이 들어가는 자리입니다 시작


포폴 내용이 들어가는 자리입니다 끝', 516, TIMESTAMP '2023-12-06 17:19:48', 1, 1002);
INSERT INTO MEETGO.POFOL (POFOL_NO, POFOL_SERVICE, POFOL_TITLE, POFOL_PRICE, POFOL_CONTENT, POFOL_VISITED,
                          POFOL_CREATE_DATE, POFOL_STATUS, GOSU_NO)
VALUES (1003, 301, '포폴 제목', '300000', '포폴 내용이 들어가는 자리입니다 시작


포폴 내용이 들어가는 자리입니다 끝', 18196, TIMESTAMP '2023-12-06 17:20:12', 1, 1003);
INSERT INTO MEETGO.POFOL (POFOL_NO, POFOL_SERVICE, POFOL_TITLE, POFOL_PRICE, POFOL_CONTENT, POFOL_VISITED,
                          POFOL_CREATE_DATE, POFOL_STATUS, GOSU_NO)
VALUES (1004, 208, '포폴 제목', '400000', '포폴 내용이 들어가는 자리입니다 시작


포폴 내용이 들어가는 자리입니다 끝', 14195, TIMESTAMP '2023-12-06 17:20:29', 1, 1004);
INSERT INTO MEETGO.POFOL (POFOL_NO, POFOL_SERVICE, POFOL_TITLE, POFOL_PRICE, POFOL_CONTENT, POFOL_VISITED,
                          POFOL_CREATE_DATE, POFOL_STATUS, GOSU_NO)
VALUES (1005, 903, '애견 훈련', '500000', '포폴 내용이 들어가는 자리입니다 시작


포폴 내용이 들어가는 자리입니다 끝', 888453, TIMESTAMP '2023-12-07 09:37:43', 1, 1005);
